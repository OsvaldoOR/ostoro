...
$connect = new PDO("mysql:host=localhost;dbname=ostoro","root","");
...
if($method == 'PUT')
{
    ...
    $query = "
    UPDATE personas SET Nombre = :Nombre, apPaterno = :apMaterno, apMaterno = :apMaterno, edad = :edad, telefono = :telefono 
    WHERE id = :id";
    $statement = $connect->prepare($query);
    $statement->execute($data);
}
